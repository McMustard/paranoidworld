export class PwRegisterHelpers {
  static init() {
    ...
    Handlebars.registerHelper('pwTags', function(tagsInput) {
    ...
    Handlebars.registerHelper('getLabel', function(obj, key) {
      ...
      if (key == 'BOND') {
        let override = game.settings.get('paranoidworld', 'bondSingle') ?? '';
    ...
    Handlebars.registerHelper('localizeOverride', function(i18nKey, settingKey = false) {
      let result = settingKey ? game.settings.get('paranoidworld', settingKey) : '';
